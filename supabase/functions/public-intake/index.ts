...
const TRAMITES: Record<string, { seccion: 'arbitraje' | 'jprd'; nombre: string; pago: boolean; expediente?: boolean; sumilla?: boolean; asunto?: boolean }> = {
    ...
    incorporacion_arbitros: { seccion: 'arbitraje', nombre: 'Incorporación a la nómina de Árbitros', pago: false },
    ...
    incorporacion_adjudicadores: { seccion: 'jprd', nombre: 'Incorporación a la nómina de adjudicadores', pago: false },
